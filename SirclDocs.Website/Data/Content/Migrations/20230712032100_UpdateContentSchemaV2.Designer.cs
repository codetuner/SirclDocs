...
namespace SirclDocs.Website.Data.Content.Migrations
{
    ...
    [Migration("20230712032100_UpdateContentSchemaV2")]
    partial class UpdateContentSchemaV2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SirclDocs.Website.Data.Content.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SirclDocs.Website.Data.Content.PropertyType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SirclDocs.Website.Data.Content.Document", b =>
                {
                    b.HasOne("SirclDocs.Website.Data.Content.DocumentType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("SirclDocs.Website.Data.Content.DocumentType", b =>
                {
                    b.HasOne("SirclDocs.Website.Data.Content.DocumentType", "Base")
                        .WithMany()
            ...
            modelBuilder.Entity("SirclDocs.Website.Data.Content.Property", b =>
                {
                    ...
                    b.HasOne("SirclDocs.Website.Data.Content.PropertyType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId");
            ...
            modelBuilder.Entity("SirclDocs.Website.Data.Content.PropertyType", b =>
                {
                    b.HasOne("SirclDocs.Website.Data.Content.DataType", "DataType")
                        .WithMany()
                        .HasForeignKey("DataTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SirclDocs.Website.Data.Content.DocumentType", "DocumentType")
